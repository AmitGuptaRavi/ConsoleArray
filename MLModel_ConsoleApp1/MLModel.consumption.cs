...
namespace MLModel_ConsoleApp1
{
    public partial class MLModel
    {
        ...
        public class ModelOutput
        {
            ...
            [ColumnName(@"ReviewType")]
            public float[] ReviewType { get; set; }
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("Review");
            if (labelColumn == null)
            {
                throw new Exception("Review column not found. Make sure the name searched for matches the name in the schema.");
            }
